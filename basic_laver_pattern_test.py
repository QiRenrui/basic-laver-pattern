    ...
    def modify(self):
        ...
        for i in range(v - u + 1):
            ...
            for elem in self.a[0][u + i]:
                ...
                if new_val == -1:
                    print("Something unpleasant happened. Please contact the author (E-mail: reflecting_ordinal@outlook.com) about the previous pattern so he can improve the rule design.")
                    return a_prime
